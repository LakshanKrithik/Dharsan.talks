...
function DitheredWaves({
  ...
  useFrame(({ clock }) => {
    // FIX: target the literal GPU copy of the uniforms
    ...
    u.resolution.value.copy(waveUniformsRef.current.resolution.value);
  });
  ...
  return (
    <>
      ...
      {/* FIX: the raycaster completely ignores "visible={false}" meshes in React Three Fiber.
          Removed visible={false} and used opacity=0 so it still responds to the mouse pointer. */}
      <mesh
